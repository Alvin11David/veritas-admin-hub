...
export default function ScholarshipsPage() {
  ...
  const activeCount = data.filter((item) => getStatus(item) !== "Closed").length;
        ...
        <div className="mx-auto max-w-6xl space-y-4">
          <Card className="border-border/80 shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Admins manage scholarship records here. Add, edit, or delete links and deadlines from this table.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {data.length === 0 ? (
                <div className="flex min-h-72 flex-col items-center justify-center rounded-xl border border-dashed border-border bg-muted/20 p-8 text-center">
                  ...
                  <h3 className="mt-4 text-lg font-semibold text-foreground">No scholarships yet</h3>
                      ...
                      render: (item) => {
                        ...
                        return (
                          <Badge
                            ...
                            className={status === "Closing Soon" ? "bg-amber-500/15 text-amber-700 border-amber-200" : ""}
                          >
                            {status}
                          </Badge>
                        );
