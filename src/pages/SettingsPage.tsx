  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Manage workspace-level settings for the admin software.</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Choose the software name displayed in the sidebar and browser tab title.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form className="space-y-4" onSubmit={onSubmit}>
            <div className="space-y-2">
              ...
              <Input
                ...
                maxLength={80}
              />
              <p className="text-xs text-muted-foreground">Empty values automatically fall back to the default name.</p>
            </div>
